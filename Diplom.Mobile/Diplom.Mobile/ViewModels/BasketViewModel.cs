    ...
    public class BasketViewModel
    {
        ...
        public BasketViewModel()
        {
            ...
            var basket = RequestBuilder.Create()
                                       ...
                                       .GetAwaiter().GetResult(); //  https://192.168.0.4:5002/api/basket/basketGet
            //if(!basket.Any())
            //{
            //    Access = false;
            //    return;
        ...
        public async Task DeleteBasket(BasketList del)
        {
            ...
            var basket = await RequestBuilder.Create()
                                             .AppendPathSegments("api", "basket", "basketGet") // добавляет к ендпоинт
                                             .GetJsonAsync<BasketList[]>(); //  https://192.168.0.4:5002/api/basket/basketGet
        ...
        public async Task AddQuantity(BasketList del)
        {
            ...
            var basket = await RequestBuilder.Create()
                                             .AppendPathSegments("api", "basket", "basketGet") // добавляет к ендпоинт
                                             .GetJsonAsync<BasketList[]>(); //  https://192.168.0.4:5002/api/basket/basketOneAdd
        ...
        public async Task LowerQuantity(BasketList del)
        {
            ...
            var basket = await RequestBuilder.Create()
                                             .AppendPathSegments("api", "basket", "basketGet") // добавляет к ендпоинт
                                             .GetJsonAsync<BasketList[]>(); //  https://192.168.0.4:5002/api/basket/basketOneDell
